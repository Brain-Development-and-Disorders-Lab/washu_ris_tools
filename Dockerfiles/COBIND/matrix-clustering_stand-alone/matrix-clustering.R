...
# Rscript bin/clustering/matrix-clustering_stand-alone/matrix-clustering.R             -i example_analysis_human_sox2/results/tf_families_tables/SOX2_cobinder.tab             -m cor --cor_th 0.7 --Ncor 0.4             --number_of_workers 1             --minimal_output TRUE             -o example_analysis_human_sox2/results/clustering_results/SOX2/cobinder/SOX2_cobinder
# matrix.file.table <- "/home/jaime/Documents/Academics/RSAT_related/cobind_tool/bin/clustering/for_jaime/example_analysis_human_sox2/results/tf_families_tables/SOX2_cobinder.tab"
# out.folder        <- "/home/jaime/Documents/Academics/RSAT_related/cobind_tool/bin/clustering/for_jaime/example_analysis_human_sox2/JAIME_DEBUG/SOX2_cobinder"
# 
# 
...
export.indiv.motif.files(un.motifs = all.motifs.um,
                         alignment.table = results.list$Alignment_table,
